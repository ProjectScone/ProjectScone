...
| release reasons | silence 49 | semantic_complete 28, silence 6, semantic_incomplete_timeout 3 |
...
`semantic_incomplete_timeout`). The two held complete turns are the two
...
The fixture is scripted text with modelled timing, not recorded speech:
