...
our evidence mode (notes, then a fold), refine, accumulate, and
LlamaIndex's TreeSummarize. Sides run one after another per item, their
...
OURS = ("evidence", "refine", "accumulate")
